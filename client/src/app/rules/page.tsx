  ...
  return (
    <div className="mx-auto max-w-3xl">
      <header className="anim-rise px-1 pb-5 pt-2">
        <h1 className="text-[26px] font-bold leading-tight tracking-[-0.03em] text-slate-950">인텍트 커뮤니티 규칙</h1>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">어렵게 쓴 규칙 아닙니다. 사람답게 말하고, 이상한 짓만 안 하면 됩니다.</p>
      </header>
