...
export default function AuthFrame({
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[var(--surface-muted)] text-[var(--ink)]">
      <header className="border-b border-[var(--line)] bg-white pt-[env(safe-area-inset-top)]">
      ...
      <main id="main-content" className="flex flex-1 px-5 py-6 sm:px-8 sm:py-12">
        <section className="mx-auto w-full max-w-[460px] self-start">
          <div className="mb-7 border-b border-[var(--line-strong)] pb-5 sm:mb-8">
      ...
      <footer className="px-5 pb-[calc(20px+env(safe-area-inset-bottom))] sm:px-8 sm:pb-7">
