...
export default function IgkShopPage() {
  ...
  return <div className="app-page mx-auto w-full max-w-[1200px] px-4 py-4 sm:px-6 lg:px-8">
    <PageHeading title="IGK 상점" actions={<Link href="/igk" className="inline-flex h-9 items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 text-xs font-bold text-slate-700 shadow-[var(--shadow-xs)] transition-all duration-200 hover:-translate-y-px hover:border-slate-300 hover:bg-slate-50 hover:shadow-[var(--shadow-sm)] active:scale-[0.97]"><ArrowLeft className="h-4 w-4" /> IGK 지갑</Link>} />
